...
def graph_connectivity(perm, edge_index, edge_weight, score, ratio, batch, num_nodes, device):
    ...
    fill_value=1
    index_E, value_E = StAS(index_A, value_A, index_S, value_S, device, num_nodes, kN)
