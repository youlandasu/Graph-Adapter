...
from prompt_files.transformer_utils.activations import ACT2FN
from prompt_files.transformer_utils.file_utils import (
    DUMMY_INPUTS,
    DUMMY_MASK,
...
from prompt_files.transformer_utils.modeling_outputs import (
    BaseModelOutput,
    BaseModelOutputWithPastAndCrossAttentions,
    Seq2SeqLMOutput,
    Seq2SeqModelOutput,
)
from prompt_files.transformer_utils.modeling_utils import PreTrainedModel, find_pruneable_heads_and_indices, prune_linear_layer
from prompt_files.transformer_utils import logging
from prompt_files.t5_model.model_parallel_utils import assert_device_map, get_device_map
