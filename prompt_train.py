...
def main(hparams):
    ...
    if hparams.do_train:
        if hparams.multi:
            ...
            model.initialize_graphprompt_by_trained_graph({i: i for i in range(hparams.num_domain_prompt)})# TODO: initialize graph
            ...
            # Begin training each dataset in dataset_order
            for task_num, task_id in enumerate(dataset_order):
                ...
                if hparams.CL in ['FW_PROMPT', 'FWBW_PROMPT'] and task_num < len(dataset_order) - 1:
                    ...
                    if hparams.select_init: # select_init == False
                        ...
                        # initizalize training the cur domain with the last doamin's all trained prompts
                        model.initialize_metaprompt_by_trained_prompt(
